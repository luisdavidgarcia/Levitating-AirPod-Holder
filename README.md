...
To demonstrate to the integration of all these circuits a video is shown below. 
...
Befor and after the marble enters the coil, the Arduino is actively monitoring the frequency of the metal detector circuit using a 555 timer's Vout pin
